        ...
        <div class="container-fluid p-0">
            <div class="owl-carousel header-carousel position-relative">
                <div class="owl-carousel-item position-relative">
                    <img class="img-fluid" src="img/daily1.jpg" alt="">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(43, 57, 64, .5);">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                    <h1 class="display-3 text-white animated slideInDown mb-4">Find The Perfect Job That You Deserved</h1>
                                    <p class="fs-5 fw-medium text-white mb-4 pb-2">you can easily find a job according to your intrest</p>
                ...
                <div class="owl-carousel-item position-relative">
                    <img class="img-fluid" src="img/daily2.jpg" alt="">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(43, 57, 64, .5);">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                        <a class="cat-item rounded p-4" href="">
                            ...
                            <h6 class="mb-3">cooking</h6>
                            <p class="mb-0">8 Vacancy</p>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                        <div class="row g-0 about-bg rounded overflow-hidden">
                            ...
                            <div class="col-6 text-start">
                                <img class="img-fluid" src="img/about2.jpeg" style="width: 85%; margin-top: 15%;">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid" src="img/about3.jpeg" style="width: 85%;">
                            </div>
                            <div class="col-6 text-end">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <p class="mb-4">find out jobs easily in our website by simple click</p>
                        <p><i class="fa fa-check text-primary me-3"></i>login our website</p>
                        <p><i class="fa fa-check text-primary me-3"></i>search a job or</p>
                        <p><i class="fa fa-check text-primary me-3"></i>post a job</p>
